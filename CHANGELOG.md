...
- [#274](https://github.com/solana-foundation/create-solana-dapp/pull/274)
  [`0bdb0ce`](https://github.com/solana-foundation/create-solana-dapp/commit/0bdb0ceeb7dee37aa3a5aaec1225dd5bcac77dd3)
  Thanks [@beeman](https://github.com/beeman)! - Tighten project name validation to lowercase kebab-case npm package
  names and export the rule as a reusable `projectNameSchema` zod schema. Names with uppercase characters, underscores,
  dots, or leading/trailing/consecutive dashes are now rejected at the prompt, since the project name is written into
  the generated `package.json` and used as the search key when renaming the template.
...
- [#277](https://github.com/solana-foundation/create-solana-dapp/pull/277)
  [`e9c1bba`](https://github.com/solana-foundation/create-solana-dapp/commit/e9c1bbafd9fee14b8feaa7329af1ab79454b3626)
  Thanks [@beeman](https://github.com/beeman)! - Apply every init-script rename in a single pass per file, so a project
  name that contains a template term is no longer compounded (`mycountergill` no longer became `mymycountergillgill`).
